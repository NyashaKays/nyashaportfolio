  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          // REPLACE THIS KEY WITH YOUR OWN WEB3FORMS KEY
    ...
    <>
      <section id="contact" className="py-24">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl text-left max-w-xl mx-auto relative overflow-hidden">
            
            {status === 'success' && (
              <div className="absolute inset-0 bg-slate-900/95 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-8 text-center">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button 
                ...
                className="w-full bg-cyan-500 hover:bg-cyan-600 disabled:opacity-50 text-white font-semibold py-4 rounded-lg transition-colors flex items-center justify-center gap-2"
              >
      ...
      <footer className="border-t border-slate-800 py-12 bg-slate-950">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex space-x-4">
            <a href="https://www.linkedin.com/in/nyashadzashe-katsidzira-804719195/" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-900 text-slate-400 hover:text-cyan-400 rounded-lg hover:bg-slate-800 transition-all" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="https://github.com/NyashaKays/" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-900 text-slate-400 hover:text-cyan-400 rounded-lg hover:bg-slate-800 transition-all" aria-label="GitHub">
            ...
            <a href="https://x.com/nyasha_thefirst" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-900 text-slate-400 hover:text-cyan-400 rounded-lg hover:bg-slate-800 transition-all" aria-label="X (Twitter)">
